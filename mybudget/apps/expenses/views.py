...
def expenses(request):
    ...
    my_expenses = get_list_or_404(Expenses.objects.filter(date__range=(current_month_start_day(), datetime.datetime.today())))
    expenses_sum = Expenses.objects.filter(date__range=(current_month_start_day(),
