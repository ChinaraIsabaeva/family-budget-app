...
from mybudget.lib import start_date
...
class ExpensesDateMethodTests(TestCase):
    ...
    def test_different_years(self):
        ...
        self.assertEqual(start_date(date).strftime('%Y, %m, %d'), '2013, 12, 28')
    ...
    def test_edge_two(self):
        ...
        self.assertEqual(start_date(date).strftime('%Y, %m, %d'), '2014, 01, 28')
    ...
    def test_check_feb_two(self):
        ...
        self.assertEqual(start_date(date).strftime('%Y, %m, %d'), '2014, 02, 28')
