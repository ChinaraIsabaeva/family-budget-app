...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Envelopes.onetime_envelope'
        db.alter_column(u'budget_envelopes', 'onetime_envelope', self.gf('django.db.models.fields.BooleanField')(default=False))

    def backwards(self, orm):

        # Changing field 'Envelopes.onetime_envelope'
        db.alter_column(u'budget_envelopes', 'onetime_envelope', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        u'budget.envelopes': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'onetime_envelope': ('django.db.models.fields.BooleanField', [], {})
        },
        u'budget.expenses': {
