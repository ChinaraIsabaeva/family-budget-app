...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'budget_envelopes', 'current_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
    ...
    models = {
        ...
        u'general.envelopes': {
            ...
            'current_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
